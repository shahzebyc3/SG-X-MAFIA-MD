...
cmd({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://files.catbox.moe/81zei9.jpg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "SG-X-MAFIA-MD 🥀",
            body: config.DESCRIPTION || "SG-X-MAFIA-MD 🤌💗",
            mediaType: 1,
